...
$sql = "SELECT items.*,subcategories.name as sname,categories.name as cname,brands.name as bname,subcategories.id as sid FROM items INNER JOIN brands ON items.brand_id=brands.id INNER JOIN subcategories ON items.subcategory_id=subcategories.id INNER JOIN categories ON subcategories.category_id=categories.id
 where items.id=?";
...
?>
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
				<a href="item_detail.php?id=<?=$ritid?>">
